...
void SetShapesTexture(RL_Texture2D texture, RL_Rectangle source)
{
...
// Draw a pixel
void DrawPixel(int posX, int posY, RL_Color color)
{
  DrawPixelV((RL_Vector2){ (float)posX, (float)posY }, color);
}

// Draw a pixel (Vector version)
void DrawPixelV(RL_Vector2 position, RL_Color color)
{
...
// Draw a line
void DrawLine(int startPosX, int startPosY, int endPosX, int endPosY, RL_Color color)
{
    rlBegin(RL_LINES);
        rlColor4ub(color.r, color.g, color.b, color.a);
...
void DrawLineV(RL_Vector2 startPos, RL_Vector2 endPos, RL_Color color)
{
    rlBegin(RL_LINES);
        rlColor4ub(color.r, color.g, color.b, color.a);
...
void DrawLineEx(RL_Vector2 startPos, RL_Vector2 endPos, float thick, RL_Color color)
{
...
void DrawLineBezier(RL_Vector2 startPos, RL_Vector2 endPos, float thick, RL_Color color)
{
    RL_Vector2 previous = startPos;
    RL_Vector2 current = { 0 };

    RL_Vector2 points[2*SPLINE_LINE_DIVISIONS + 2] = { 0 };
...
void DrawLineBezierQuad(RL_Vector2 startPos, RL_Vector2 endPos, RL_Vector2 controlPos, float thick, RL_Color color)
{
...
void DrawLineBezierCubic(RL_Vector2 startPos, RL_Vector2 endPos, RL_Vector2 startControlPos, RL_Vector2 endControlPos, float thick, RL_Color color)
{
    const float step = 1.0f/SPLINE_LINE_DIVISIONS;
...
void DrawLineBSpline(RL_Vector2 *points, int pointCount, float thick, RL_Color color)
{
    ...
    RL_Vector2 vertices[2*SPLINE_LINE_DIVISIONS + 2] = { 0 };
...
void DrawLineCatmullRom(RL_Vector2 *points, int pointCount, float thick, RL_Color color)
{
    if (pointCount < 4) return;
...
// Draw lines sequence
void DrawLineStrip(RL_Vector2 *points, int pointCount, RL_Color color)
{
    if (pointCount >= 2)
    {
        rlBegin(RL_LINES);
...
void DrawCircle(int centerX, int centerY, float radius, RL_Color color)
{
    DrawCircleV((RL_Vector2){ (float)centerX, (float)centerY }, radius, color);
}

// Draw a color-filled circle (Vector version)
// NOTE: On OpenGL 3.3 and ES2 we use QUADS to avoid drawing order issues
void DrawCircleV(RL_Vector2 center, float radius, RL_Color color)
{
    DrawCircleSector(center, radius, 0, 360, 36, color);
}

// Draw a piece of a circle
void DrawCircleSector(RL_Vector2 center, float radius, float startAngle, float endAngle, int segments, RL_Color color)
{
...
void DrawCircleSectorLines(RL_Vector2 center, float radius, float startAngle, float endAngle, int segments, RL_Color color)
{
...
void DrawCircleGradient(int centerX, int centerY, float radius, RL_Color color1, RL_Color color2)
{
    rlBegin(RL_TRIANGLES);
...
// Draw circle outline
void DrawCircleLines(int centerX, int centerY, float radius, RL_Color color)
{
    rlBegin(RL_LINES);
        rlColor4ub(color.r, color.g, color.b, color.a);
...
// Draw ellipse
void DrawEllipse(int centerX, int centerY, float radiusH, float radiusV, RL_Color color)
{
    rlBegin(RL_TRIANGLES);
        for (int i = 0; i < 360; i += 10)
        {
...
void DrawEllipseLines(int centerX, int centerY, float radiusH, float radiusV, RL_Color color)
{
    rlBegin(RL_LINES);
        for (int i = 0; i < 360; i += 10)
        {
...
// Draw ring
void DrawRing(RL_Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int segments, RL_Color color)
{
...
// Draw ring outline
void DrawRingLines(RL_Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int segments, RL_Color color)
{
    if (startAngle == endAngle) return;
...
void DrawRectangle(int posX, int posY, int width, int height, RL_Color color)
{
    DrawRectangleV((RL_Vector2){ (float)posX, (float)posY }, (RL_Vector2){ (float)width, (float)height }, color);
}

// Draw a color-filled rectangle (Vector version)
// NOTE: On OpenGL 3.3 and ES2 we use QUADS to avoid drawing order issues
void DrawRectangleV(RL_Vector2 position, RL_Vector2 size, RL_Color color)
{
    DrawRectanglePro((RL_Rectangle){ position.x, position.y, size.x, size.y }, (RL_Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle
void DrawRectangleRec(RL_Rectangle rec, RL_Color color)
{
    DrawRectanglePro(rec, (RL_Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle with pro parameters
void DrawRectanglePro(RL_Rectangle rec, RL_Vector2 origin, float rotation, RL_Color color)
{
...
void DrawRectangleGradientV(int posX, int posY, int width, int height, RL_Color color1, RL_Color color2)
{
...
// NOTE: Gradient goes from bottom (color1) to top (color2)
void DrawRectangleGradientH(int posX, int posY, int width, int height, RL_Color color1, RL_Color color2)
{
...
void DrawRectangleGradientEx(RL_Rectangle rec, RL_Color col1, RL_Color col2, RL_Color col3, RL_Color col4)
{
    rlSetTexture(texShapes.id);
...
// NOTE: On OpenGL 3.3 and ES2 we use QUADS to avoid drawing order issues
void DrawRectangleLines(int posX, int posY, int width, int height, RL_Color color)
{
#if defined(SUPPORT_QUADS_DRAW_MODE)
...
void DrawRectangleLinesEx(RL_Rectangle rec, float lineThick, RL_Color color)
{
...
void DrawRectangleRounded(RL_Rectangle rec, float roundness, int segments, RL_Color color)
{
...
void DrawRectangleRoundedLines(RL_Rectangle rec, float roundness, int segments, float lineThick, RL_Color color)
{
...
void DrawTriangle(RL_Vector2 v1, RL_Vector2 v2, RL_Vector2 v3, RL_Color color)
{
#if defined(SUPPORT_QUADS_DRAW_MODE)
    rlSetTexture(texShapes.id);
...
// NOTE: Vertex must be provided in counter-clockwise order
void DrawTriangleLines(RL_Vector2 v1, RL_Vector2 v2, RL_Vector2 v3, RL_Color color)
{
    rlBegin(RL_LINES);
        rlColor4ub(color.r, color.g, color.b, color.a);
        rlVertex2f(v1.x, v1.y);
...
void DrawTriangleFan(RL_Vector2 *points, int pointCount, RL_Color color)
{
    if (pointCount >= 3)
    {
        rlSetTexture(texShapes.id);
...
void DrawTriangleStrip(RL_Vector2 *points, int pointCount, RL_Color color)
{
    if (pointCount >= 3)
    {
        rlBegin(RL_TRIANGLES);
...
void DrawPoly(RL_Vector2 center, int sides, float radius, float rotation, RL_Color color)
{
    if (sides < 3) sides = 3;
...
void DrawPolyLines(RL_Vector2 center, int sides, float radius, float rotation, RL_Color color)
{
    if (sides < 3) sides = 3;
    float centralAngle = rotation*DEG2RAD;
    float angleStep = 360.0f/(float)sides*DEG2RAD;
...
void DrawPolyLinesEx(RL_Vector2 center, int sides, float radius, float rotation, float lineThick, RL_Color color)
{
    if (sides < 3) sides = 3;
    float centralAngle = rotation*DEG2RAD;
...
bool CheckCollisionPointRec(RL_Vector2 point, RL_Rectangle rec)
{
...
bool CheckCollisionPointCircle(RL_Vector2 point, RL_Vector2 center, float radius)
{
    bool collision = false;
...
bool CheckCollisionPointTriangle(RL_Vector2 point, RL_Vector2 p1, RL_Vector2 p2, RL_Vector2 p3)
{
    bool collision = false;
...
bool CheckCollisionPointPoly(RL_Vector2 point, RL_Vector2 *points, int pointCount)
{
    bool collision = false;
    ...
    if (pointCount > 2)
    {
        for (int i = 0; i < pointCount - 1; i++)
        {
            RL_Vector2 vc = points[i];
            RL_Vector2 vn = points[i + 1];
...
bool CheckCollisionCircles(RL_Vector2 center1, float radius1, RL_Vector2 center2, float radius2)
{
    bool collision = false;
...
bool CheckCollisionCircleRec(RL_Vector2 center, float radius, RL_Rectangle rec)
{
    bool collision = false;
...
bool CheckCollisionLines(RL_Vector2 startPos1, RL_Vector2 endPos1, RL_Vector2 startPos2, RL_Vector2 endPos2, RL_Vector2 *collisionPoint)
{
    bool collision = false;
...
bool CheckCollisionPointLine(RL_Vector2 point, RL_Vector2 p1, RL_Vector2 p2, int threshold)
{
    bool collision = false;
