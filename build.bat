...
set LIB_PATHS=-L./bin "-L/Program Files/vcpkg/installed/x64-windows/lib"
set INCLUDES=-I./deps/tsoding -I./deps/raylib/src -I./deps/ail "-I/Program Files/vcpkg/installed/x64-windows/include/libusb-1.0"
